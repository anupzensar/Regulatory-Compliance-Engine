...
//     e.preventDefault();
//     const { runTest, isLoading, error, result } = useComplianceTest();
//     resetOrchestrator();
...
const HomePage = () => {
  ...
  return (
    <div className={`min-h-screen ${themeClasses} transition-colors duration-200`}>
      {/* Header */}
      <header
        className={`${isDarkMode ? "bg-slate-700" : "bg-white"} border-b ${
              ...
              <div className="space-y-3">
                {availableTestCases.map((testCase) => {
                  ...
                  return (
                    <div
                      key={testCase.id}
                      className={`flex items-center justify-between p-4 rounded-lg border ${testCaseClasses} hover:${
                        isDarkMode ? "bg-slate-500" : "bg-gray-50"
